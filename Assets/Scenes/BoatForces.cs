...
public class BoatForces : IYachtControls
{
    ...
    public static float rudder_angle = 0;
    ...
    public override void rotateRudder(int angle){
        ...
        //BoatForces.rudder_angle += angle * 5;
        //Debug.Log("Rudder Angle: " + BoatForces.rudder_angle);
    }

    public static void rotateRudderMLAgent(int angle)
    {
        BoatForces.rudder_angle = angle;
    }


    public void ForceRudder() {
        yachtRigidbody.AddForceAtPosition(transform.right * BoatForces.rudder_angle * getVelocity().magnitude, rudder.transform.position, ForceMode.Force);
    }
